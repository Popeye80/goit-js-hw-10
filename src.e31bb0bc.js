...
var fetchCountries = function fetchCountries(name) {
  var LINK = 'https://restcountries.com/v2';
  var FILTER_RESPONSE = 'name,capital,population,flags,languages';
  return fetch("".concat(LINK, "/name/").concat(name, "?fields=").concat(FILTER_RESPONSE)).then(function (response) {
    if (!response.ok) {
...
},{}],"js/generatingDom.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.generatingSomeCountryInDom = exports.generatingOneCountryInDom = void 0;

var generatingOneCountryInDom = function generatingOneCountryInDom(country) {
...
var generatingSomeCountryInDom = function generatingSomeCountryInDom(countries) {
...
var _generatingDom = require("./js/generatingDom");
...
function onKeydown(evt) {
  ...
  (0, _fetchCountries.fetchCountries)(countryName).then(function (countries) {
    clearCountriesInDOM();
    ...
    if (countries.length === 1) {
      refs.div.innerHTML = (0, _generatingDom.generatingOneCountryInDom)(countries[0]);
      return;
    }

    refs.ul.innerHTML = (0, _generatingDom.generatingSomeCountryInDom)(countries);
...
},{"./css/styles.css":"css/styles.css","./js/fetchCountries":"js/fetchCountries.js","./js/generatingDom":"js/generatingDom.js","notiflix/build/notiflix-notify-aio":"../node_modules/notiflix/build/notiflix-notify-aio.js","lodash.debounce":"../node_modules/lodash.debounce/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
